...
export default function HotelMessages() {
      ...
      messages?.forEach((msg: any) => {
        ...
        if (!conversationMap.has(key)) {
          conversationMap.set(key, {
            ...
            last_message: msg.content || msg.message, // Handle both schema possibilities
            last_message_time: msg.created_at,
            // UPDATED: Check 'is_read' based on previous schema files
  ...
  const openConversation = (conv: Conversation) => {
    ...
    // UPDATED: Path /owner/ -> /hotel/
    router.push({
      pathname: "/(hotel)/conversation/[id]" as any,
      params: {
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtitle}>
            {searchQuery
              ...
              : "Messages from interested NGOs will appear here"}
          </Text>
        </View>
      ) : (
        <FlatList
